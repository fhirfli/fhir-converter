...
var getMultipleWeightLogResources = function (weightLogs) {
	var observations = [];
      ...
      observations.push(createBmiObservation(weightLog));
    	observations.push(createFatObservation(weightLog));
  	});
  	return observations;
}
...
var getWeightResources = function (weightLogs) {
	var observations = [];
  	weightLogs.forEach(function(weightLog) {
    	observations.push(createBmiObservation(weightLog));
    	observations.push(createWeightObservation(weightLog));
  	});
  	return observations;
}
...
var createWeightObservation = function (weightLog) {
	var result = {
...
var createFatObservation = function (weightLog) {
  var result = {
    fullUrl: "urn:uuid:13723207-8864-4465-9840-ff4b522146b3",
    request: {
      method: "POST",
